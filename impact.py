...
print(f"Émission équivalent CO2 (g): {Co2_emissions_A100}")
print(f"Impact environnemental total (g): {impact_total_A100_values}")
...
print(f"Émission équivalent CO2 (g): {Co2_emissions_jetson}")
print(f"Impact environnemental total (g): {impact_total_jetson_values}")

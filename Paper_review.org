...
** 5° paper : Edge Intelligence: The Confluence of Edge Computing and Artificial Intelligence (https://arxiv.org/pdf/1909.00560)
*** Keywords :
...
+ Edge Inteligence road-map :
  ...
  #+end_center
  + "In this paper, we define an edge site as a micro data center with applications deployed, attached to a Small-cell Base Station (SBS). "

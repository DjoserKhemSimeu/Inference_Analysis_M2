...
file_paths = glob.glob('data_L40S_v4.1/FULL/consommation_energie_single_L40S_QC_*_*.csv')
ci_paths = glob.glob('data_L40S_v4.1/CI/consommation_energie_single_L40S_QC_*_*_ci.csv')

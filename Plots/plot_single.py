...
for bs in bs_values:
    ...
    data_A100 = pd.read_csv(f'data/consommation_energie_A100x1_single_BS_{bs}_EL_31__.csv')
    data_jetson = pd.read_csv(f'data/consommation_energie_jetson_single_BS_{bs}_EL_31__.csv')

...
for bs in bs_values:
    ...
    data_A100 = pd.read_csv(f'data/consommation_energie_A100x1_server_BS_{bs}_QPS_360.csv')
    data_jetson = pd.read_csv(f'data/consommation_energie_jetson_server_BS_{bs}_QPS_360.csv')

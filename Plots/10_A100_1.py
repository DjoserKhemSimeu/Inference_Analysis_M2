...
file_paths = glob.glob('data_A100_v1.1/FULL/consommation_energie_single_A100_QC_*_*.csv')
ci_paths = glob.glob('data_A100_v1.1/CI/consommation_energie_single_A100_QC_*_*_ci.csv')

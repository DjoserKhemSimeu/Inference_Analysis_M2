...
file_paths = glob.glob('../Data/data_H100_v4.1/FULL/consommation_energie_single_H100_QC_*_*.csv')
ci_paths = glob.glob('../Data/data_H100_v4.1/CI/consommation_energie_single_H100_QC_*_*_ci.csv')

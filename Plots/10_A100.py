...
file_paths = glob.glob('../Data/data_A100_v4.1/FULL/consommation_energie_single_A100_QC_*_*.csv')
ci_paths = glob.glob('../Data/data_A100_v4.1/CI/consommation_energie_single_A100_QC_*_*_ci.csv')
...
for idx, (condition, data_list) in enumerate(data_by_condition.items()):
    ...
    ax.set_title(f'A100 v4.1 : QC {condition}',fontsize=10)

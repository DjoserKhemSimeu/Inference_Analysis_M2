...
data_A100 = pd.read_csv('data/consommation_energie_A100x1_server.csv')
data_jetson = pd.read_csv('data/consommation_energie_jetson_server.csv')
...
print(f"Émission équivalent CO2 conception  (g): {np.mean(impact_total_A100_values-Co2_emissions_A100)}")
...
print(f"Émission équivalent CO2 conception  (g): {np.mean(impact_total_jetson_values-Co2_emissions_jetson)}")

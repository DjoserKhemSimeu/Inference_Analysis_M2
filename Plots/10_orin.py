...
file_paths = glob.glob('data_orin_v4.1/FULL/consommation_energie_single_orin_QC_*_*.csv')
ci_paths = glob.glob('data_orin_v4.1/CI/consommation_energie_single_orin_QC_*_*_ci.csv')
